...
You can use the AWS CLI to synthesize SSML input text\. The following examples show how to perform common task using the AWS CLI\. 
...
The following examples show how to use SSML tags to complete common Amazon Polly tasks\. For more SSML tags, see [SSML Tags Supported by Amazon Polly](supported-ssml.md)\. 
...
For more information on this element, see [Controlling How Special Types of Words Are Spoken ](supported-ssml.md#say-as-tag)\.
